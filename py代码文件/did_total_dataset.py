...
Using Total Dataset (No PSM Matching)

Dataset: 总数据集_2007-2023_完整版_无缺失FDI.xlsx
Sample: 4,819 observations × 285 cities
Period: 2007-2023

Specification: Alternative with fdi_openness + industrial_advanced
"""
...
def load_and_prepare_data():
    """Load total dataset and prepare for DID regression"""
...
def format_results_table(results, var_names):
    ...
    main_vars = ['DID', 'ln_pgdp', 'ln_pop_density', 'industrial_advanced',
                'fdi_openness', 'ln_road_area']
...
def save_results(summary_df, results):
    ...
    output_path = '多时点DID_总数据集分析/DID_总数据集_回归结果.xlsx'
...
def main():
    """Main execution"""
    print("="*70)
    print("Multi-period DID Analysis - Total Dataset")
    print("No PSM Matching")
    print("="*70)
