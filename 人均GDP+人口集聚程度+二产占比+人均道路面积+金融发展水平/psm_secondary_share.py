...
控制变量组合: 人均GDP + 人口集聚程度 + 二产占比 + 人均道路面积 + 金融发展水平
...
class PropensityScoreMatcher:
    ...
    控制变量组合:
    - ln_pgdp: 人均GDP (对数)
    - ln_pop_density: 人口集聚程度/人口密度 (对数)
    - secondary_share: 二产占比 (水平值)
...
def main():
    ...
    print("  3. secondary_share - 二产占比 (水平值)")
    print("  4. ln_road_area - 人均道路面积 (对数)")
    print("  5. financial_development - 金融发展水平 (水平值)")
    print("="*60)

    # 读取数据
    print("\n[OK] 读取数据...")
    data = pd.read_excel(r'总数据集_2007-2023_含二产占比_含金融发展水平.xlsx')
