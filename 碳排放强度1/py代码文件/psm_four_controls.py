...
def main():
    ...
    print("  3. tertiary_share - 第三产业占GDP比重 (水平值)")
    print("  4. ln_fdi - 外商直接投资 (对数)")
    print("="*60)

    # 读取数据
    print("\n[OK] 读取数据...")
    data = pd.read_excel('总数据集_2007-2023_完整版_无缺失FDI_修正pop_density_添加金融发展水平.xlsx')
    ...
    # 生成报告
    output_prefix = '人均GDP+人口集聚程度+第二产业比重+外商投资水平/PSM_'
