...
class PropensityScoreMatcher:
    ...
    def save_results(self, output_prefix='倾向得分匹配_2012-2017版本'):
        """
        保存匹配结果到Excel
...
def main():
    ...
    # 读取最终回归版数据（2012/2017版本）
    df = pd.read_excel('总数据集_2012-2017版本.xlsx')

    print(f"数据集加载成功（2012/2017版本）: {df.shape[0]} 行 × {df.shape[1]} 列")
